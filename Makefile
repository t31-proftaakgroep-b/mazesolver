...
$(SERVER_TARGET): $(SERVER_SOURCES) $(SERVER_OBJECTS) $(MAZESOLVER_OBJECTS) $(SOLUTION_OBJECTS) $(HEADERS)
	@$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(COMMUNICATION_OBJECTS) $(MAZE_OBJECTS) $(MAZESOLVER_OBJECTS) $(SOLUTION_OBJECTS) -o $@ $(SERVER_SOURCES)
...
$(MOTOR_TARGET): $(MOTOR_SOURCES) $(MOTOR_OBJECTS) $(HEADERS)
	@$(CXX) $(CXXFLAGS) $(CPPFLAGS) -o $@ $(MOTOR_SOURCES)
...
upload:
	scp $(PRINTER) dev:/home/robot/$(PRINTER)
	ssh dev './$(PRINTER)'
...
clean:
	...
	@rm -f $(SERVER_OBJECTS) $(CLIENT_OBJECTS) $(SCANNER_OBJECTS) $(PLOTTER_OBJECTS) $(TCPCLIENT_OBJECTS) $(COMMUNICATION_OBJECTS) $(MAZESOLVER_OBJECTS) $(MOTOR_OBJECTS) $(PLOTTERPROXY_OBJECTS) $(PLOTTERSTATEMACHINE_OBJECTS) $(SENSOR_OBJECTS) $(SCANNERPROXY_OBJECTS) $(MAZE_OBJECTS) $(SOLUTION_OBJECTS) $(SCANNERSIMULATOR_OBJECTS) $(SCANNERSTATEMACHINE_OBJECTS)./*/*.o
