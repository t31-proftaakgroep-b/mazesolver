...
all: $(COMMUNICATION_TARGET) $(SERVER_TARGET) $(CLIENT_TARGET) $(SCANNER_TARGET) $(PLOTTER_TARGET) $(TCPCLIENT_TARGET)  $(MAZESOLVER_TARGET) $(MOTOR_TARGET) $(PLOTTERPROXY_TARGET) $(PLOTTERSTATEMACHINE_TARGET) $(SENSOR_TARGET) $(SCANNERPROXY_TARGET) $(MAZE_TARGET) $(SOLUTION_TARGET)

$(SERVER_TARGET): $(SERVER_SOURCES) $(SERVER_OBJECTS) $(HEADERS)
	@$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(COMMUNICATION_OBJECTS) -o $@ $(SERVER_SOURCES)
...
clean:
	@rm -f $(SERVER_TARGET) $(CLIENT_TARGET) $(SCANNER_TARGET) $(PLOTTER_TARGET) $(TCPCLIENT_TARGET) $(COMMUNICATION_TARGET) $(MAZESOLVER_TARGET) $(MOTOR_TARGET) $(PLOTTERPROXY_TARGET) $(PLOTTERSTATEMACHINE_TARGET) $(SENSOR_TARGET) $(SCANNERPROXY_TARGET) $(MAZE_TARGET) $(SOLUTION_TARGET) ./*/*.o
	@rm -f $(SERVER_OBJECTS) $(CLIENT_OBJECTS) $(SCANNER_OBJECTS) $(PLOTTER_OBJECTS) $(TCPCLIENT_OBJECTS) $(COMMUNICATION_OBJECTS) $(MAZESOLVER_OBJECTS) $(MOTOR_OBJECTS) $(PLOTTERPROXY_OBJECTS) $(PLOTTERSTATEMACHINE_OBJECTS) $(SENSOR_OBJECTS) $(SCANNERPROXY_OBJECTS) $(MAZE_OBJECTS) $(SOLUTION_OBJECTS) ./*/*.o
